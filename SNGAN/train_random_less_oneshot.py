...
def main():
    ...
    for ro in range(2):  # 1 for full model and 1 for random pruning
        best_fid = 1e4
        ...
        pruning_generate(gen_net, args.percent, method="random")
        pruning_generate(avg_gen_net, args.percent, method="random")
