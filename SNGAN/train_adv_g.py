...
import datasets
import random
from functions import train_adv_g, validate, LinearLrDecay, load_params, copy_params
...
def main():
    ...
    for epoch in range(int(start_epoch), int(args.max_epoch)):
        ...
        train_adv_g(args, gen_net, dis_net, gen_optimizer, dis_optimizer, gen_avg_param,\
