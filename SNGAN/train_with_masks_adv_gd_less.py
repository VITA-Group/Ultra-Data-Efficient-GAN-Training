...
from functions_adv import train_adv_gd
...
def main():
    ...
    for epoch in range(int(start_epoch), int(args.max_epoch)):
        ...
        train_adv_gd(args, gen_net, dis_net, gen_optimizer, dis_optimizer, gen_avg_param, train_loader, epoch, writer_dict, lr_schedulers, steps=args.steps, gamma=args.gamma)
