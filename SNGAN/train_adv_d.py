...
import datasets
import random
from functions import train_adv_d, validate, LinearLrDecay, load_params, copy_params
...
def main():
    ...
    for epoch in range(int(start_epoch), int(args.max_epoch)):
        ...
        train_adv_d(args, gen_net, dis_net, gen_optimizer, dis_optimizer, gen_avg_param, train_loader, epoch, writer_dict, lr_schedulers, steps=args.steps, gamma=args.gamma)
